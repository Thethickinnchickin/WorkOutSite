    ...
    <div class="row mt-4 mx-3 ">
        ...
        <div class="our_solution_category mt-3">
            ...
            <div style="background-color: black; border: 1px solid rgb(12, 247, 255)"  class="solution_card">
               ...
               <button style="color: rgb(255,215,0);"  type="button" class="read_more_btn">
               <span style="animation: blinking 1.5s infinite">Add</span></button>
                </div>
            </div>
            </div>
...
export default {
    ...
    methods: {
     ...
     routeRedirct(route) {
      ...
      async duplicateExercise(workoutId, exerciseId) {
