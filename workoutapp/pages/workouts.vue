<template>
  ...
  <main>
    ...
    <h2 class="pb-2 mb-5 mt-4 border-bottom">Workouts to Complete</h2>
  <div class="row mt-4">
    <div v-for="workout in workouts" :key="workout._id" class="col-4 mr-0">
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button type="button" class="read_more_btn">Go to Workout</button>
            </div>
          </div>
        </div>
...
export default {
    async asyncData({$axios}) {
        ...
        for(let workout of response.workouts)
        {
            workout.dateScheduled = moment(String(workout.dateScheduled))
                .format('MM/DD/YYYY');
            FormattedWorkouts.push(workout);
        }
