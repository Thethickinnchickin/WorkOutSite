<template>
  <main>
    <div class="isMain">
      <div id="cardSection">
        <div class="row mt-5 pt-5">
          <div class="col"></div>
          <div class="col">
            <h2 class="mt-3 border-bottom" id="pageTitle"  style="color: #82a43a;">Completed Workouts</h2>
          </div>
          <div class="col">
            <h3 id="pageNumber" class="ml-5 pr-5 mt-3">Page: {{pageNumber}}</h3>
          </div>
          <div class="col"></div>
        ...
        <div class="row mx-3 ">
          ...
          <div v-for="workout in workoutsCompleted" :key="workout._id" class="ml-5 pl-3 row">
          <div class="our_solution_category mt-3" style="min-width: 220px; max-width: 220px">
            <div class="solution_cards_box">
              <div style="background-color: black; border: 1px solid rgb(12, 247, 255)" class="solution_card">
                ...
                <div class="solu_description">
                  <button style="color: rgb(255,215,0);" @click="$router.push(`/workout/${workout._id}`)" type="button" class="read_more_btn mt-3"><span style="animation: blinking 1.5s infinite">View Score</span></button>
                </div>
              </div>
            </div>
          </div>
          </div>
          <div v-if="workoutsCompleted.length >= 3" class="row-3 ml-5 pl-3" style="min-width: 220px; max-width: 220px">
            <div @click="routeRedirct('/workout/new')" class="our_solution_category mt-3">
              <div class="solution_cards_box">
                <div style="background-color: black;  border: 1px solid rgb(12, 247, 255);" class="solution_card">
                  <div class="hover_color_bubble"></div>
                  <h2 style="font-size: 12px"  class="text-center mt-5 pt-5">Create Workout</h2>
                </div>
              </div>
            </div>        
          </div>
    ...
    <div class="isMobile" style="width: 90vw;">
       ...
       <div class="row mt-2"  >
            <div class="col">
                <ul class="pagination justify-content-center paginationMobile" >
                    ...
                    <li v-for="index in totalPages" :key="index" class="page-item">
                        <button v-if="index === pageNumber" class="page-link" @click="pageChange(index)"  style="background-color: rgb(57, 165, 17); color: white;">{{index}}</button>
                        <button v-else class="page-link" @click="pageChange(index)">{{index}}</button>
                    </li>
      ...
      <div class="row ml-2">
      <div v-for="workout in workoutsCompleted">
        <div class="col">
          <div class="cards-list" >
            
            <div class="card 3" style="background-color: black"  @click="$router.push(`/workout/${workout._id}`)">
              ...
              <div class="card_title title-white pb-5" style="font-size: 10px">
                ...
                <p class="" style="color: black">{{workout.name}}</p>
