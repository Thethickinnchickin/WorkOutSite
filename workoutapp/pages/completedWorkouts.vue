<template>
  <main>
    <div class="isMain">
        <div id="cardSection">
          <div class="row mt-5 pt-5">
            <div class="col"></div>
            <div class="col">
              <h2 class="pb-2 border-bottom" id="pageTitle"  style="color: #B33F40; text-align: center;">Incomplete Workouts</h2>
            </div>
            <div class="col">
              <h3 class="mr-5 pr-5"  id="pageNumber">Page: {{pageNumber}}</h3>        
            </div>
            <div class="col"></div>
  
          </div>
          <div class="row mx-3">
              <div v-for="workout in workoutsCompleted" :key="workout._id" class="mt-4 ml-5 pl3 row" >
              ...
              <div @click="routeRedirct('/workout/new')" class="ml-5 pl-3 row-3 mr-0 mt-3" style="min-width: 220px; max-width: 220px">
    ...
    <div class="isMobile" style="width: 90vw;">
         <div class="row mt-5">
          <div class="col">
            <h2 class="pt-5 mt-5 ml-3 border-bottom" 
            style="font-size: 10px; color: rgb(57, 165, 17)">Completed Workouts</h2>
          </div>
          <div class="col">
         ...
         <div class="row ml-3">
          ...
          <div class="row ml-4">
            <div class="" id="workout-card" v-for="workout in workoutsCompleted">
      ...
      methods: {
       ...
       routeRedirct(route) {
        ...
        let FormattedCompletedWorkouts = []
          ...
          this.workoutsCompleted = FormattedCompletedWorkouts
